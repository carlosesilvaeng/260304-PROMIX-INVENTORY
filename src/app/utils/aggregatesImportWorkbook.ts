...
function buildInstructionRows(meta: AggregatesImportMeta, materialOptions: string[], procedenciaOptions: string[]) {
  return [
    ...
    ['3', 'Si Metodo de medicion = BOX, debes completar Ancho (ft) y Alto (ft) en pies decimales. En pantalla el sistema puede capturar esos valores como pies + pulgadas.'],
